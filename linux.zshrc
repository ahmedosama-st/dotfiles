...
export ZSH="/home/ahmedosama/.oh-my-zsh"
...
alias cpssh="cat ~/.ssh/id_ed25519.pub | xclip -sel clip"
...
alias up="sudo apt update && sudo apt upgrade && sudo apt autoremove && sudo apt clean && cd && sudo ./snapcleaner.sh"
